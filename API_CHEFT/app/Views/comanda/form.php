<form id="my-form" class="">
    ...
    <select class="form-select" id="Total_platos" name="Total_platos" aria-label="Total_platos" required onchange="calculateTotal()">
        ...
        <option value="1" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 1 ? 'selected' : ''; ?>>1 Plato</option>
        <option value="2" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 2 ? 'selected' : ''; ?>>2 Platos</option>
        <option value="3" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 3 ? 'selected' : ''; ?>>3 Platos</option>
        <option value="4" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 4 ? 'selected' : ''; ?>>4 Platos</option>
        <option value="5" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 5 ? 'selected' : ''; ?>>5 Platos</option>
        <option value="6" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 6 ? 'selected' : ''; ?>>6 Platos</option>
        <option value="7" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 7 ? 'selected' : ''; ?>>7 Platos</option>
        <option value="8" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 8 ? 'selected' : ''; ?>>8 Platos</option>
        <option value="9" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 9 ? 'selected' : ''; ?>>9 Platos</option>
        <option value="10" <?php echo isset($obj['Total_platos']) && $obj['Total_platos'] == 10 ? 'selected' : ''; ?>>10 Platos</option>
    </select>
    <label for="Total_platos">Cantidad Platos</label>
</div>

    <div class="form-floating mb-3">
        <input type="number" class="form-control" id="Precio_Total" name="Precio_Total" placeholder="Precio" step="0.01" required oninput="calculateTotal()">
